<?php 
  ...
  $sql = $conn->query("SELECT * FROM tb_contacts WHERE id = $editId");
    ...
    if(empty($_POST['email'])){
      ...
      if(array_filter($errors)) {
        $errors['status'] =  "ERROR 505!! <br/>"; 
          ...
          // create sql:
          $editId = "UPDATE tb_contacts SET firstname='$firstname', lastname='$lastname', email='$email',  telephone ='$telephone' WHERE id=$id";s
              ...
              <div class="col-md-6 ">
                <form class = "small text-muted round m-5 p-3 font-weight-bold" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                    ...
                    <div class="text-center m-4 p-2">
                        <input class="btn btn-primary text-warning" type="submit" name="save" value="save">
                    </div>
